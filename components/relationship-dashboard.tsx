...
import { Search, TrendingUp, TrendingDown, Minus, Crown, Medal, Award } from "lucide-react"
...
const friends: Friend[] = [
  ...
  },
  {
    id: "3",
    name: "최유나",
    avatar: "/korean-woman-casual.jpg",
    score: 72,
    trend: "down",
    lastContact: "3일 전",
    replySpeed: "normal",
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-80px)]">
      ...
      <header className="bg-card border-b border-border px-4 py-4">
        <h1 className="text-xl font-bold text-foreground mb-3">관계 랭킹</h1>
